...
| authors        | 是   | string   | 作者，可用 et al.               | `Li et al.`                                |
| org            | 是   | string   | 所属机构                       | `Peking University`                        |
| year           | 是   | number   | 发表年份                       | `2023`                                     |
...
| weights_url    | 否   | string   | 预训练权重链接，没有则留空              | 模型权重下载链接                                   |
...
| year           | \                                                                                                            |
| type           | `deep_learning`                                                                                              |
| tasks          | Ground Roll Suppression                                                                                      |
| description    | End-to-End Ground Roll Suppression Based on U-Net                                                            |
| paper_url      | \                                                                                                            |
| code_url       | [https://github.com/sixseven42/seismic-benchmark-code](https://github.com/sixseven42/seismic-benchmark-code) |
| weights_url    | [https://huggingface.co/models](https://huggingface.co/models)                                               |
| is_open_source | `true`                                                                                                       |

...
const translations = {
  en: {
    ...
    overview: {
      ...
      teamText: 'SeismicBench is maintained by a collaborative team of geophysicists and machine learning researchers from leading institutions worldwide.',
  ...
  zh: {
    ...
    overview: {
      ...
      teamTitle: '研究团队',
      teamText: 'SeismicBench 由来自全球顶尖机构的地球物理学家和机器学习研究人员组成的协作团队维护。',
      milestonesTitle: '里程碑',
      futureTitle: '未来计划',
